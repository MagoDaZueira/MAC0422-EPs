...
void mostrar_informacoes() {
    int mostrar_pos = 0;
    if (!is_stack_empty(voltas_a_imprimir) || indice_quebrados < quebrados.size)
        printf("\n");
